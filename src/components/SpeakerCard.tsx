        ...
        <>
            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="fixed inset-0  z-[140] bg-black/40 backdrop-blur-[5px]"
            ...
            <AnimatePresence>{open && (
                <motion.div
                    ...
                    className="fixed inset-0 m-auto z-[150] w-[800px] h-[90%] max-[900px]:w-[90%] min-[1500px]:w-[70%] rounded-[10px] border-2 border-gray-300 drop-shadow-md drop-shadow-gray-600 cursor-pointer bg-white overflow-hidden"
                >
                    ...
                    <motion.div className="absolute inset-0 flex flex-row justify-end-safe items-start pointer-events-none mr-2 mt-2">
                        <motion.button
                            className="rounded-full p-[6px] bg-black/40 backdrop-blur-[14px] cursor-pointer pointer-events-auto"
                            onClick={() => setOpen(false)}
                        >
