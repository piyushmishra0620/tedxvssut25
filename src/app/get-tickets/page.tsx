  ...
  return (
    <div className="flex justify-center bg-black min-h-screen py-20">
      <div className="pt-10 flex flex-col gap-8 items-center px-6 md:px-0 w-full max-w-4xl">
        <h1 className="text-5xl text-red-500 text-center font-bold">Book Your Passes Now!</h1>
        ...
        <div className="w-full grid md:grid-cols-3 gap-8">
          {ticketOptions.map((ticket, index) => (
            ...
            >
              ...
              <h2 className="text-2xl text-white font-semibold text-center">{ticket.title}</h2>
              <p className="text-gray-300 text-center mt-2">{ticket.description}</p>
              <p className="text-gray-400 text-sm mt-1">{ticket.audience}</p>
              <p className="text-3xl text-red-500 font-bold mt-4">{ticket.price}</p>
              <Link
                href={ticket.link}
